...
void OLED_Init(void) {
    ...
    WriteCmd(0x10); //00Horizontal Addressing Mode;01Vertical Addressing Mode;10Page Addressing Mode (RESET);
...
void OLED_ShowMenu(float expect_voltage, float real_voltage) {
    OLED_ShowStr(0, 0, "Expect: ");
    OLED_ShowFloat(8 * 8, 0, expect_voltage);
    OLED_ShowStr(0, 2, "Real: ");
    OLED_ShowFloat(8 * 8, 2, real_voltage);
}